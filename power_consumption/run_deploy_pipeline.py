...
import click
from pipelines.deploy_pipeline import (
    continuous_deployment, inference_deployment
)
...
def main(config: str, min_mse: float):
    ''' run the mlfow pipeline '''
